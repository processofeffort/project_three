        ...
        <div id="login">
          ...
          <div id="loginBox">
            ...
            <el-form :model="user" :rules="rules" ref="loginForm" label-width="0px">
              ...
              <el-form-item>
                <el-button type="primary" icon="el-icon-upload" class="submit" @click="login">登录</el-button>
                <el-button type="success" icon="el-icon-download"  @click="register">注册</el-button>
              </el-form-item>
            </el-form>
          </div>
        </div>
    ...
    methods: {
      login() {
        this.$refs.loginForm.validate((valid) => {
          if (valid) {
            $http.post('/users/validate', this.user).then((res) => {
              if (res.data) {
